...
object Messages {
    fun itemNotAvailable(id: String) = "ByteItem '$id' is not available!"

    val motivationalSpeech = listOf(
            "[ByteItems] ".yellow() + "Metrics are disabled for this plugin or globally! Please consider enabling metrics.".aqua(),
